...
import { UserUpdate, UserView } from "../../../controllers/front";
...
export default function Profile() {
  ...
  const props = {
    ...
    //   if (status === "done") {
    //     message.success({
    //       content: <div className="upload-result" style={{border: '2px solid red'}}>{info.file.name}</div>,
                    ...
                    <div class="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
                                                ...
                                                <div className="mt-1 flex items-center">
                                                  ...
                                                  <div clas="file_input_wrap">
                                                    ...
                                                    <label
                                                      type="button"
                                                      for="imageUpload"
                                                      className="ml-2 rounded-md border border-gray-300 bg-white py-2 px-3 text-sm font-medium leading-4 text-gray-700 shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-[#387DFF] focus:ring-offset-2"
                                                    >
                                                      <svg
                                                        xmlns="http://www.w3.org/2000/svg"
                                                        fill="none"
                      ...
                      <div class="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                        <button
                          onClick={() => {
                            // uploadPhoto;
                            UserUpdate(dispatch, profile).then(
                              setIsEdit(!isEdit)
                            );
                          }}
                          type="button"
