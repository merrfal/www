...
export default function Cover({ cover, setCover, user }) {
  ...
  return (
    <img
      ...
      className={`sm:px-6 lg:px-8 sm:h-52 lg:h-72 h-52 w-full object-cover max-w-7xl mx-auto px-4 ${cover === null ? "scale-110 blur-2xl grayscale" : "scale-100 blur-0 grayscale-0"}`}
    />
  )
}