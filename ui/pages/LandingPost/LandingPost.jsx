        ...
        <div class="shadow sm:overflow-hidden sm:rounded-md">
          <div class="space-y-6 bg-white px-4 py-5 sm:p-6">
            ...
            <div class="col-span-6 sm:col-span-4">
                <label for="email-address" class="block text-sm font-medium text-gray-700">Titulli i Produktit</label>
            ...
            <div>
              <label for="about" class="block text-sm font-medium text-gray-700">Përshkrim</label>
              <div class="mt-1">
              ...
              <p class="mt-2 text-sm text-gray-500">Përshkrimi i gjatë i produktit tuaj. Me të gjitha karakteristikat.</p>
            </div>

            <div class="bg-white px-4 py-5 sm:p-6">
            <div class="grid grid-cols-6 gap-6">
              <div class="col-span-6">
                <label for="street-address" class="block text-sm font-medium text-gray-700">Adresa e Banimit</label>
              ...
              <div class="col-span-6 sm:col-span-6 lg:col-span-2">
                <label for="city" class="block text-sm font-medium text-gray-700">Qyteti</label>
              ...
              <div class="col-span-6 sm:col-span-3 lg:col-span-2">
                <label for="postal-code" class="block text-sm font-medium text-gray-700">Kodi Postar</label>
            ...
            <div>
              <label class="block text-sm font-medium text-gray-700">Fotoja Kryesore</label>
              <div class="mt-1 flex justify-center rounded-md border-2 border-dashed border-gray-300 px-6 pt-5 pb-6">
                <div class="space-y-1 text-center">
                  ...
                  <p class="text-xs text-gray-500">PNG, JPG, që nuj tejkalonë madhësin e 3MB</p>
                </div>
              </div>
            </div>
          </div>
          <div class="bg-gray-50 px-4 py-3 text-right sm:px-6">
            <button type="submit" class="inline-flex justify-center rounded-md border border-transparent bg-indigo-600 py-2 px-4 text-sm font-medium text-white shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">Bismilah, Listo Produktin</button>
          </div>
        </div>
      </form>
    </div>
