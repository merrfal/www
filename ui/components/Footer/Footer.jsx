  ...
  return (
    <footer aria-labelledby='footer-heading' class='bg-white mb-8'>
      <div class='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 '>
        <div class='border-t border-gray-200 pt-20 pb-10 border-b border-gray-40'>
          <div class='grid grid-cols-1 md:grid-cols-12 md:grid-flow-col md:gap-x-6 md:gap-y-16 md:auto-rows-min'>
            <Link href="/">
              <div class='hover:cursor-pointer col-span-1 md:col-span-2 lg:row-start-1 lg:col-start-1'>
                <svg
                  class='h-8 w-auto'
                  width='95'
                  height='65'
            ...
            <div class='mt-10 col-span-6 grid grid-cols-2 gap-8 sm:grid-cols-3 md:mt-0 md:row-start-1 md:col-start-3 md:col-span-8 lg:col-start-2 lg:col-span-7'>
