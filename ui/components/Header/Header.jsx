...
<path d="M370.362 65.8401H381.783V3.39762H370.362V65.8401Z" fill="black"/>
      ...
      <nav class="hidden space-x-10 md:flex">
        ...
        <Link href='/'>
          <a href="#" class="text-base font-medium text-gray-500 hover:text-gray-900">Ballina</a>
        </Link>

        <Link href='/landings'>
          <a href="#" class="text-base font-medium text-gray-500 hover:text-gray-900">Produktet</a>
        </Link>
      ...
      <div style={{ display: 'flex' }}>
          {user.Auth ? (
            <div style={{ display: 'flex',  }}>
              <Link href='/posts/add'>
                <a href="#" class="text-base font-medium text-gray-500 hover:text-gray-900">Add Landing Page</a>
              </Link>

              <Link href={`/users/${user.Username}`}>
                <a href="#" class="text-base font-medium text-gray-500 hover:text-gray-900">Welcome, {user.FullName}</a>
              </Link>

              <Link href={`/posts`}>
                <a href="#" class="text-base font-medium text-gray-500 hover:text-gray-900">My Landing Pages</a>
              </Link>

              <Link href={`/account`}>
                <a href="#" class="text-base font-medium text-gray-500 hover:text-gray-900">Edit Profile</a>
              </Link>

              <button onClick={() => dispatch(LogoutUser())}>
                <a href="#" class="text-base font-medium text-gray-500 hover:text-gray-900">Log Out</a>
              </button>
            </div>
          ) : (
            <div>
        ...
        <button onClick={() => AuthWithGoogle()}  class="ml-8 inline-flex items-center justify-center whitespace-nowrap rounded-md border border-transparent bg-indigo-600 px-4 py-2 text-base font-medium text-white shadow-sm hover:bg-indigo-700">Auth with Google</button>
